public class MD5 {
    public static byte[] compute(byte[] message) {
        final int INIT_A = 0x67452301;
        final int INIT_B = (int) 0xEFCDAB89L;
        final int INIT_C = (int) 0x98BADCFEL;
        final int INIT_D = 0x10325476;
        final int[] SHIFT_AMTS = {7, 12, 17, 22, 5, 9, 14, 20, 4,
                11, 16, 23, 6, 10, 15, 21};
        final int[] TABLE_T = new int[64];
        for (int i = 0; i < 64; i++)
    ...
    public static void main(String[] args) {
        String message = "This is painless"
